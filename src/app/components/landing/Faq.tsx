...
const faqs = [
    ...
    {
      question: "How do faculty members access salary details?",
      answer:
        "Faculty members can log in to the faculty portal and view their salary details under the 'Payroll' section, which also allows them to download salary slips for each month.",
    },
    {
    ...
    <div className="bg-gray-50">
      <div className="mx-auto max-w-9xl py-10">
        <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
          <h2 className="text-3xl font-bold leading-10 tracking-wide text-gray-900 text-center">Frequently asked questions</h2>
