      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-800 sm:text-4xl">
            Portals for Students, and Admin
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Each portal is designed to cater to specific users, allowing easy
            access and management of financial transactions and records for
            students, employees, and the accounts department.
          </p>
        </div>
        <div className="mx-auto max-w-2xl mt-10 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-3 gap-x-10 gap-y-16 lg:max-w-none lg:grid-cols-2">
