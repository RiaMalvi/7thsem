  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          router.push('/studentLogin'); // Redirect to the login page after signup
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-center text-gray-800">Student Signup</h2>
        ...
        <p className="mt-4 text-center text-gray-600">
          Already have an account? <a href="/studentLogin" className="text-blue-600 hover:underline">Login</a>
        </p>
      </div>
    </div>
  );
